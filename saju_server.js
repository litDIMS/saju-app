...
const PORTONE_STORE_ID   = process.env.PORTONE_STORE_ID  || 'store-de077400-ac17-42fd-8977-7dc7f21d4aa6';
const PORTONE_CHANNEL_KEY= process.env.PORTONE_CHANNEL_KEY || 'channel-key-d06e4df0-a803-4860-9d6b-2f6b574b49a4';
